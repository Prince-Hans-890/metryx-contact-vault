      ...
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center group">
             {/* Ensure 'metryx-full-logo.png' is in your public folder */}
            <img 
              src="/metryx-full-logo.png" 
              alt="Metryx" 
...
// --- THIS PART WAS AT THE BOTTOM OF YOUR FILE ---
// I have kept it here so your code doesn't break.
