...
const Index = () => {
  ...
  const features = [
    {
      // Original: text-primary | Dark: text-indigo-500
  ...
  return (
    // Base: gradient-hero (Light) | Dark: bg-slate-950 (Dark)
    <div className="min-h-screen bg-gradient-hero dark:bg-slate-950 dark:text-slate-100 transition-colors duration-500">
      ...
      <section className="relative pt-40 pb-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        {/* Overlay: Standard for Light, Hidden/Modified for Dark */}
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-5xl mx-auto text-center animate-fade-in-up">
            ...
            {/* Badge */}
            <div className="inline-block mb-6 px-6 py-2 rounded-full bg-gradient-glass backdrop-blur-md border border-primary/20 shadow-lg dark:bg-slate-900/50 dark:border-slate-800">
              <span className="text-sm font-semibold bg-gradient-primary bg-clip-text text-transparent dark:text-slate-300 dark:bg-none">
                🚀 Leading Web Development Agency
              </span>
            </div>

            {/* Main Title */}
            <h1 className="text-6xl sm:text-7xl lg:text-8xl font-extrabold text-foreground mb-8 leading-tight dark:text-white">
              Transform Your Vision Into
            </h1>

            {/* Typing Text */}
            <div className="h-24 flex items-center justify-center mb-10">
              <h2 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold bg-gradient-primary bg-clip-text text-transparent drop-shadow-lg dark:bg-gradient-to-r dark:from-purple-400 dark:via-blue-400 dark:to-indigo-400">
                {typedText}
            ...
            {/* Subtext */}
            <p className="text-xl sm:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto leading-relaxed dark:text-slate-400">
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center">
              <Button
                size="lg"
                variant="gradient"
                className="dark:bg-purple-600 dark:text-white dark:hover:bg-purple-700 dark:shadow-purple-500/25 dark:border-0"
              ...
              <Button
                ...
                variant="glass"
                asChild
                className="dark:border-slate-700 dark:text-white dark:hover:bg-slate-800 dark:bg-transparent"
              >
      ...
      {/* Features Section */}
      <section className="py-28 px-4 sm:px-6 lg:px-8 bg-background relative dark:bg-slate-900/50">
        <div className="container mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="text-5xl sm:text-6xl font-extrabold text-foreground mb-6 dark:text-white">Why Choose Metryx?</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed dark:text-slate-400">
      ...
      {/* CTA Section */}
      <section className="relative py-28 px-4 sm:px-6 lg:px-8 bg-gradient-overlay overflow-hidden dark:bg-slate-950 dark:bg-none">
        <div className="absolute inset-0 bg-gradient-hero opacity-50 dark:hidden" />
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center bg-gradient-card backdrop-blur-sm rounded-3xl p-16 shadow-xl border border-border/50 dark:bg-slate-900 dark:border-slate-800">
            <h2 className="text-5xl sm:text-6xl font-extrabold text-foreground mb-6 leading-tight dark:text-white">
              Ready to Build Something Amazing?
            </h2>
            <p className="text-xl sm:text-2xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed dark:text-slate-400">
              Let's discuss your project and turn your ideas into reality. Get a free consultation today.
            </p>
            <Button
              size="lg"
              variant="gradient"
              className="dark:bg-white dark:text-slate-900 dark:hover:bg-slate-200 dark:border-0"
              onClick={() => setContactModalOpen(true)}
            >
              Get Started Now
              <ArrowRight className="ml-2 w-5 h-5" />
